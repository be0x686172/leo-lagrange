...
const TableContainerFeature = ({ clickable, version, columns, data, lengthData, slice, changeSlice }) => {
    ...
    return (
        <div className='table-container-feature'>
            ...
            {version === 'users' ? <TableTableContainerFeature clickable={clickable} columns={columns} data={data} version={version} lengthData={lengthData} slice={slice} changeSlice={changeSlice}/> : (
                <div>
                    <TableTableContainerFeature clickable={clickable} columns={columns} data={data} version={version} lengthData={lengthData} setCandidatId={setCandidatId} slice={slice} changeSlice={changeSlice}/>
